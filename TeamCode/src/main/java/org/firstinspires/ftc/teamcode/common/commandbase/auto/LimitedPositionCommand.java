...
public class LimitedPositionCommand extends CommandBase {
    ...
    public LimitedPositionCommand(SwerveDrivetrain drivetrain, Localizer localizer, Pose targetPose, double delay, double dead, double voltage) {
        ...
        this.delay = delay;
        this.v = voltage;
        this.initialPose = localizer.getPos();
    }

    public LimitedPositionCommand(SwerveDrivetrain drivetrain, Localizer localizer, Pose targetPose, double delay, double voltage) {
        this.drivetrain = drivetrain;
        this.localizer = localizer;
        this.targetPose = targetPose;
    ...
    public Pose goToPosition(Pose robotPose, Pose targetPose) {
        Pose t = new Pose(targetPose.x, targetPose.y, targetPose.heading);
        t.y = initialPose.y + slewRateLimiter.calculate(t.y - initialPose.y);

        Pose deltaPose = t.subtract(robotPose);
