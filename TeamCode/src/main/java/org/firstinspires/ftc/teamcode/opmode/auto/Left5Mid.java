...
import static org.firstinspires.ftc.teamcode.common.hardware.Constants.Side;
import static org.firstinspires.ftc.teamcode.common.hardware.Constants.side;
...
public class Left5Mid extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStarted()) {
            ...
            telemetry.addLine("RUNNING LEFT 5 CYCLE MID");
        ...
        CommandScheduler.getInstance().schedule(
                new SequentialCommandGroup(
                        new ParallelCommandGroup(
                                new SequentialCommandGroup(
                                        new PositionCommand(drivetrain, localizer, new Pose(47, -1, 0.22899), 500, 2500, hardwareMap.voltageSensor.iterator().next().getVoltage()),
//                                        new PrecisePositionCommand(drivetrain, localizer, new Pose(59, -1, -0.22899), 500, 18000, hardwareMap.voltageSensor.iterator().next().getVoltage())
                                ...
                                new WaitCommand(2500).andThen(new SequentialCommandGroup(
                                        new AutoCycleCommand(robot, CYCLE_GRAB_POSITIONS[0], robot.lift.getHeightMid()),
                                        new AutoCycleCommand(robot, CYCLE_GRAB_POSITIONS[1], robot.lift.getHeightMid()),
                                        new AutoCycleCommand(robot, CYCLE_GRAB_POSITIONS[2], robot.lift.getHeightMid()),
                                        new AutoCycleCommand(robot, CYCLE_GRAB_POSITIONS[3], robot.lift.getHeightMid()),
                                        new AutoCycleCommand(robot, CYCLE_GRAB_POSITIONS[4], robot.lift.getHeightMid()),
