...
public class BetterSwerveLocalizer implements Localizer, com.acmerobotics.roadrunner.localization.Localizer {
    public SwerveModuleServo.SwerveModuleState[] modules;
    public DoubleSupplier imu;
    public Pose2d poseEstimate;
    public Pose2d pastPoseEstimate;
    public BetterSwerveLocalizer(DoubleSupplier i, SwerveModuleServo... mods){
        modules = Arrays.stream(mods).map(SwerveModuleServo::asState).toArray(SwerveModuleServo.SwerveModuleState[]::new);
        imu = i;
    ...
    public void update() {
        ...
        for(SwerveModuleServo.SwerveModuleState s : modules){
